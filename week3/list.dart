...
void main() {
  // bir bankaya on musteri gelir bunlarin 100tlsi 50 tlsi vardır
  ...
  String name = '';
  // 0, 1, 2
  List<int> moneys = {100, 110, 500, 200, 300} as List<int>;
  final List<int> newMoneys = {100, 110, 500, 200, 300} as List<int>;
