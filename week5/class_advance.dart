void main() {
 ...
 // musterinin yası 18den kucuk kontolu yapar misin
 ...
 if ((user.age ?? 10) < 18) {}
  ...
  // kullanicilarimin parasi var ama paranin tipi degisken olabilir
  // parasi olan adamin o parametresi bir isimde olabilir veya deger olabilir
  // tr yazacak yada orada 15 yazabilir
  // ekranda goster
  final _newType = user.moneyType is String ? user.moneyType : ""; 
  ...
  print(moneyBank1 == money2);
  final newResult = "a" + "a";

  // musteri banka sinifindan iki kisinin parasini toplayip sonucu söyler misin
